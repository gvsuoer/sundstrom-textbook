...
\begin{enumerate}[\exer{exer:evenodd}]
...
\begin{enumerate}[\exer{exer:evenoddadd}]
...
\emph{\item \textbf{Proof of (b)}}.  Assume that $x$ is an even integer and $y$ is an odd integer.  We will prove that $x + y$ is an odd integer.  Since $x$ is even and $y$ is odd, there exist integers $m$ and $n$ such that
\[
...
\begin{enumerate}[\exer{exer:evenoddmult}]
\item \begin{enumerate} \usecounter{enumii} \item
\begin{tabular}[t]{|p{0.4in}|p{1.6in}|p{1.6in}|}
  \hline
  \textbf{Step}  &  \textbf{Know}  &  \textbf{Reason} \\ \hline
...
\begin{enumerate}[\exer{exer:5m+7}]
\item \begin{enumerate} \usecounter{enumii}
...
\begin{enumerate}[\exer{exer:sec12-7}]
\item \begin{enumerate} \usecounter{enumii}
...
\begin{enumerate}[\exer{exer:sec12-new7}]
\item \begin{enumerate} \usecounter{enumii}
...
\begin{enumerate}[\exer{exer:sec12-8}]
\item
\begin{tabular}[t]{|p{0.4in}|p{1.6in}|p{1.6in}|}
  \hline
  \textbf{Step}  &  \textbf{Know}  &  \textbf{Reason} \\ \hline
...
\begin{enumerate}[\exer{exer:sec12-type}] 
\item \begin{enumerate} \usecounter{enumii}
...
\begin{enumerate}[\exer{exer:sec12-typeproof}]
\item \begin{enumerate} \usecounter{enumii}
...
\begin{enumerate}[\exer{exer:sec12-11}]
\item \begin{enumerate} \usecounter{enumii}
...
\begin{enumerate}[\exer{exer:sec12-quadratic2}]
\item \begin{enumerate} \usecounter{enumii}
