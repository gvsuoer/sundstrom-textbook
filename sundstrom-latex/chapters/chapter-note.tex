...
\chapter{Note to Students} \label{fm:stud_note}
...
\begin{itemize}
  \item \textbf{Beginning Activities.}  %With the exception of Sections~\ref{S:prop} and~\ref{S:reviewproofs}, each section has exactly two beginning activities.  Some of these
...
%\url{http://www.youtube.com/playlist?list=PL2419488168AE7001}
\end{center}
...
%\begin{center}
%%\url{https://sites.google.com/site/mathematicalreasoning3ed/}
%\url{http://gvsu.edu/s/0Rn}
%\end{center}
